...
(async () => {
  ...
  async function handleLanguageChange() {
    ...
    if (!languagesByName[newLanguageName]) {
      const url = './tree-sitter-edoc.wasm'
  ...
  function loadState() {
    const language = localStorage.getItem("languageEdoc");
    const sourceCode = localStorage.getItem("sourceCodeEdoc");
    const query = localStorage.getItem("queryEdoc");
    const queryEnabled = localStorage.getItem("queryEnabledEdoc");
  ...
  function saveState() {
    localStorage.setItem("languageEdoc", languageSelect.value);
    localStorage.setItem("sourceCodeEdoc", codeEditor.getValue());
    saveQueryState();
  }

  function saveQueryState() {
    localStorage.setItem("queryEnabledEdoc", queryCheckbox.checked);
    localStorage.setItem("queryEdoc", queryEditor.getValue());
  }
